package com.it_tech613.tvtimes1.ui.home;
...
import com.it_tech613.tvtimes1.models.MovieModel;
...
public class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.HomeListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HomeListViewHolder holder, final int position) {
        ...
        switch (position){
            case 0:
                if (MyApp.firstServer != FirstServer.second) holder.name.setText(context.getResources().getString(R.string.featured_live_tv));
        ...
        if (MyApp.firstServer != FirstServer.second || position != 0)
