...
import com.it_tech613.tvtimes1.models.FirstServer;
import com.it_tech613.tvtimes1.models.FullModel;
import com.it_tech613.tvtimes1.ui.catchup.FragmentCatchupCategory;
import com.it_tech613.tvtimes1.ui.home.FragmentHome;

import com.it_tech613.tvtimes1.ui.liveTv.FragmentExoLiveTv;
import com.it_tech613.tvtimes1.ui.liveTv.FragmentIjkLiveTv;
import com.it_tech613.tvtimes1.ui.liveTv.FragmentLiveTv;
import androidx.fragment.app.Fragment;
import androidx.recyclerview.widget.LinearLayoutManager;
import com.it_tech613.tvtimes1.models.SideMenu;
import com.it_tech613.tvtimes1.ui.catchup.FragmentCatchupDetail;
import com.it_tech613.tvtimes1.ui.movies.FragmentAllMovie;
import com.it_tech613.tvtimes1.ui.movies.FragmentMovieDetail;
import com.it_tech613.tvtimes1.ui.movies.FragmentMovies;
import com.it_tech613.tvtimes1.ui.multi.FragmentMultiScreen;
import com.it_tech613.tvtimes1.ui.multi.PinMultiScreenDlg;
import com.it_tech613.tvtimes1.ui.series.FragmentEpisodes;
import com.it_tech613.tvtimes1.ui.series.FragmentSeries;
import com.it_tech613.tvtimes1.ui.series.FragmentSeriesHolder;
import com.it_tech613.tvtimes1.ui.settings.FragmentSettings;
import com.it_tech613.tvtimes1.ui.tvGuide.FragmentTvGuide;
import com.it_tech613.tvtimes1.ui.series.FragmentSeasons;
import com.it_tech613.tvtimes1.utils.MyFragment;
import com.it_tech613.tvtimes1.vpn.fastconnect.core.OpenConnectManagementThread;
import com.it_tech613.tvtimes1.vpn.fastconnect.core.OpenVpnService;
import com.it_tech613.tvtimes1.vpn.fastconnect.core.VPNConnector;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (MyApp.firstServer != FirstServer.second)fragmentList.add(new FragmentLiveTv());
        if (MyApp.firstServer != FirstServer.second)fragmentList.add(new FragmentMultiScreen());
        fragmentList.add(new FragmentMovies());
        fragmentList.add(new FragmentSeries());
        if (MyApp.firstServer != FirstServer.second)fragmentList.add(new FragmentTvGuide());
        if (MyApp.firstServer != FirstServer.second)fragmentList.add(new FragmentCatchupCategory());
        ...
        if (MyApp.firstServer != FirstServer.second)list.add(new SideMenu("Live Tv"));
        if (MyApp.firstServer != FirstServer.second)list.add(new SideMenu("Multi TV"));
        list.add(new SideMenu("Movies"));
        list.add(new SideMenu("Series"));
        if (MyApp.firstServer != FirstServer.second)list.add(new SideMenu("Tv Guide"));
        list.add(new SideMenu("Sports Guide"));
        if (MyApp.firstServer != FirstServer.second)list.add(new SideMenu("Catchup"));
